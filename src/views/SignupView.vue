  ...
  <div class="auth-container">
    <div class="auth-card">
      <div class="auth-header">
        ...
        <p>Join us and contribute to a greener future</p>
      </div>
      <form class="auth-form" @submit.prevent="handleAuth">
        ...
        <button class="auth-btn primary" @click="handleAuth">Sign Up</button>
      </form>
...
function handleAuth() {
  localStorage.setItem('user_name', fullName.value || 'User')
